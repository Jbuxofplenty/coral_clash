...
import { Dimensions, Image, ImageBackground, Platform, ScrollView, StyleSheet } from 'react-native';
      ...
      <Block flex style={styles.Login}>
        <Block flex>
          <ImageBackground
            ...
            <Block flex style={styles.LoginDetails}>
              <Block style={styles.LoginTexts}>
